...
public:
	...
	bool appUpdate(float fElapsedTime) override
	{
		...
		// draw lines
		DrawLine(center, GetVector(-hours * 5 - progress, fRadius - 35, 60) + center, gck::GREEN);
		DrawLine(center, GetVector(-minutes, fRadius - 18, 60) + center, gck::BLUE);
		DrawLine(center, GetVector(-seconds, fRadius - 5, 60) + center, gck::RED);
